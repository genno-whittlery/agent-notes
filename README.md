...
| **2026-02** | rolling | [`2026-02-cursor-2-and-ide-agents.md`](./2026-02-cursor-2-and-ide-agents.md) | Cursor 2.0 (Feb 2026) — 8 background agents on cloud VMs with git worktree isolation + Composer model; the IDE-embedded agent category (Cursor / Cline / Continue.dev / Windsurf) |
| **2026-02** | rolling | [`2026-02-devin-cognition.md`](./2026-02-devin-cognition.md) | Devin / Cognition Labs February 2026 update — parallel sessions + improved context retention; the "engineer-as-architect" thesis; canonical autonomous-end of the agent spectrum |
...
| **2026** | rolling | [`2026-mcp-protocol.md`](./2026-mcp-protocol.md) | Model Context Protocol — Anthropic-originated, donated to Linux Foundation Dec 2025; 97M+ monthly SDK downloads; the cross-vendor "USB-C for AI" connector standard |
| **2026** | rolling | [`2026-agents-md-standard.md`](./2026-agents-md-standard.md) | AGENTS.md — cross-vendor coding-agent instructions file (Codex CLI, Copilot, Cursor, Windsurf, Amp, Devin all read it); CLAUDE.md's sibling, also donated to Linux Foundation Dec 2025 |
| **2026** | rolling | [`2026-evaluation-infrastructure.md`](./2026-evaluation-infrastructure.md) | Coding-agent evaluation: SWE-bench Verified, vertical benchmarks, LLM-as-judge and its biases, the 2026 production-evaluation discipline. Fills the gap flagged in the agentic-engineering umbrella entry |
| **2026** | rolling | [`2026-discovery-method.md`](./2026-discovery-method.md) | **Meta:** how to find hot topics systematically — five-tier intake stack, the hot-topic detection rules, the 3-source verification discipline, cadence model. The methodology behind the rest of this repo |
| **2026** | rolling | [`2026-vibecoding-tools.md`](./2026-vibecoding-tools.md) | Lovable / Bolt / v0 / Replit Agent — the non-developer-audience tool category (Collins Word of the Year 2025); $100M-ARR-with-tiny-teams shape Blomfield cites |
| **2026** | rolling | [`2026-ai-browsers.md`](./2026-ai-browsers.md) | ChatGPT Atlas (Oct 2025) + Perplexity Comet (July 2025) — agentic-browser category; agent-drives-controlled-environment shape applied to web; Webwright is the DIY equivalent |
| **2026** | rolling | [`2026-aider-cli.md`](./2026-aider-cli.md) | Aider (Paul Gauthier) — precision-edits pair programmer; 4.2× fewer tokens than Claude Code on diff-shaped tasks; TDD-with-AI discipline matured here first |
